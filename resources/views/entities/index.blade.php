<x-app-layout title="Entities Database">
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            ...
            {{-- Tombol dibuat responsif dengan warna teks yang benar --}}
        ...
        {{-- Ganti Tabel lama dengan Grid Kartu Dossier --}}
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div class="p-4 flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="w-full sm:w-1/3 flex-shrink-0">
                        <a href="{{ route('entities.show', $entity) }}">
                            ...
                            @else
                            {{-- Placeholder jika tidak ada gambar (kode ini tetap sama) --}}
                            <div
                ...
                {{-- Footer Aksi --}}
                <div class="px-4 py-2 border-t-2 border-border-color flex justify-end gap-3">
                    <a href="{{ route('entities.edit', $entity) }}"
                        class="text-secondary hover:text-primary text-sm font-mono">> EDIT</a>
                    <a href="{{ route('entities.show', $entity) }}"
                        class="text-primary hover:text-white text-sm font-bold font-mono">> ACCESS DOSSIER</a>
                </div>
            </div>
            @empty
