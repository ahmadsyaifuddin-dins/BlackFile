...
>
    {{-- Konten Modal --}}
    <div @click.outside="isModalOpen = false" class="bg-gray-900 border border-gray-700 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div class="p-6 font-mono">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="name" id="name" x-model="formData.name" class="form-input-dark" required>
                    </div>
                    <div>
                        <label for="codename" class="block text-gray-400 text-sm mb-1">> Codename</label>
                        <input type="text" name="codename" id="codename" x-model="formData.codename" class="form-input-dark" required>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="project_type" id="project_type" x-model="formData.project_type" class="form-input-dark" placeholder="e.g., Web Application" required>
                    </div>
                    <div>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" id="description" rows="3" x-model="formData.description" class="form-input-dark" required></textarea>
                </div>
                
                {{-- Tech Stack --}}
                <div class="mb-4">
                    <label for="tech_stack" class="block text-gray-400 text-sm mb-1">> Tech Stack <span class="text-gray-500">(comma-separated)</span></label>
                    <input type="text" name="tech_stack" id="tech_stack" x-model="formData.tech_stack" class="form-input-dark" placeholder="e.g., Laravel, Vue, MySQL">
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="url" name="repository_url" id="repository_url" x-model="formData.repository_url" class="form-input-dark" placeholder="https://">
                    </div>
                    <div>
                        <label for="live_url" class="block text-gray-400 text-sm mb-1">> Live URL</label>
                        <input type="url" name="live_url" id="live_url" x-model="formData.live_url" class="form-input-dark" placeholder="https://">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="datetime-local" name="start_date" id="start_date" x-model="formData.start_date" class="form-input-dark">
                    </div>
                    <div>
                        <label for="completed_date" class="block text-gray-400 text-sm mb-1">> Completed Date</label>
                        <input type="datetime-local" name="completed_date" id="completed_date" x-model="formData.completed_date" class="form-input-dark">
                    </div>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="file" name="cover_image" id="cover_image" class="form-input-dark file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-green-800 file:text-green-300 hover:file:bg-green-700">
                    {{-- Tampilkan gambar saat ini jika sedang mode edit --}}
                    <template x-if="isEditMode && formData.cover_image_path">
                        <div class="mt-2">
                            <img x-bind:src="'/' + formData.cover_image_path" alt="Current Cover" class="max-h-32 rounded">
