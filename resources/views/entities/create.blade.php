        ...
        <form action="{{ route('entities.store') }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <div x-data="{ open: false, selected: '{{ old('category', $categories[0] ?? '') }}' }"
                ...
                <div>
                    ...
                    <div x-data="{ open: false, selected: '{{ old('rank', $ranks[0] ?? '') }}' }"
                        class="relative font-mono">
                ...
                <div>
                    ...
                    <div x-data="{ open: false, selected: '{{ old('origin', $origins[0] ?? '') }}' }"
                        class="relative font-mono">
