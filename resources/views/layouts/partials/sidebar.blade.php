<aside class="w-64 bg-surface border-r bg-black border-border-color flex flex-col transition-transform duration-300 ease-in-out z-20
    ...
    <nav class="flex-1 p-4 space-y-2 overflow-y-auto text-green-700">
        ...
        {{-- Item tambahan --}}
        <a href="#"
            class="flex items-center space-x-3 px-3 py-2 rounded-r-md transition-colors border-l-4 border-transparent hover:bg-surface-light hover:border-primary/50"><span>>
                Kontak Terenkripsi</span></a>
