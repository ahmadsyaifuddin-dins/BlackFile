<div class="bg-surface border border-border-color rounded-md p-4 font-mono">
    <form action="{{ $searchRoute }}" method="GET">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
            ...
            <div class="sm:col-span-2 lg:col-span-2">
                <label for="search" class="block text-base font-medium text-primary mb-1">Search (Name, Desc, Tag)</label>
                <x-forms.input 
                    name="search" 
                    id="search" 
            ...
            <div>
                <x-forms.select 
                    label="Category"
                    name="category"
                    :options="$categories" {{-- Asumsi $categories sudah berupa array --}}
